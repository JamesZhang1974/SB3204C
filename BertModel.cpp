...
QList<uint8_t> BertModel::i2cAddresses_PCA9557  = { 0x1C };
...
bool BertModel::SelectModel(const QString &code)
{
    if (code == "SB3204C")
    {
        ...
        modelCode = "SB3204C";
        i2cAddresses_GT1724   = { 0x12,       0x14,      };
        i2cAddresses_LMX2594  = { 0x28,       0x2C       };
        i2cAddresses_PCA9557  = { 0x1C,       0x18       };
    ...
    if (code == "SB3204C_FS")
    {
        ...
        i2cAddresses_PCA9557  = { 0x1C,       0x1C       };
