...
QT_MOC_LITERAL(1, 7, 19), // "transactionFinished"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 16), // "transactionStart"
QT_MOC_LITERAL(4, 45, 14), // "const uint8_t*"
QT_MOC_LITERAL(5, 60, 4), // "data"
QT_MOC_LITERAL(6, 65, 6), // "size_t"
QT_MOC_LITERAL(7, 72, 10), // "nBytesData"
QT_MOC_LITERAL(8, 83, 22), // "nBytesResponseExpected"
QT_MOC_LITERAL(9, 106, 17), // "transactionCancel"
QT_MOC_LITERAL(10, 124, 13), // "dataAvailable"
QT_MOC_LITERAL(11, 138, 11) // "dataWritten"

    },
    "Serial\0transactionFinished\0\0"
    "transactionStart\0const uint8_t*\0data\0"
    "size_t\0nBytesData\0nBytesResponseExpected\0"
    "transactionCancel\0dataAvailable\0"
    "dataWritten"
};
...
void Serial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->transactionFinished(); break;
        case 1: _t->transactionStart((*reinterpret_cast< const uint8_t*(*)>(_a[1])),(*reinterpret_cast< const size_t(*)>(_a[2])),(*reinterpret_cast< const size_t(*)>(_a[3]))); break;
        case 2: _t->transactionCancel(); break;
        case 3: _t->dataAvailable(); break;
        case 4: _t->dataWritten(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Serial::transactionFinished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Serial::transactionFinished()
{
